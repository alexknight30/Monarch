...
const DocumentAttachmentIcon = forwardRef<DocumentAttachmentIconHandle, DocumentAttachmentIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <div data-design-id="m-73e764661050"
      ...
      >
        <svg
          ...
          overflow="visible"
        >
          <motion.path data-design-id="m-9848494a2a90"
          ...
          />
          <motion.path data-design-id="m-caed5a7570dd"
            d="M7.5 7H16.5"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          />
          <motion.path data-design-id="m-ea60b3529bfc"
            d="M7.5 12H13.5"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          />
          <motion.path data-design-id="m-28a48657f90e"
