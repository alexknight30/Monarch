...
const Copy01Icon = forwardRef<Copy01IconHandle, Copy01IconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <div data-design-id="m-b95a90ce79d5"
        ...
        >
          <defs>
            ...
            >
              ...
              <motion.g data-design-id="m-e8e55b132fae"
                variants={generatedGeometryVariants}
                animate={controls}
                initial="normal"
              >
                <motion.path data-design-id="m-42b993157915"
                  d={FRONT_PATH}
                  fill="black"
                  stroke="black"
          ...
          <motion.path data-design-id="m-6ea798fa4e6c"
            d={FRONT_PATH}
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
            ...
            style={{ transformOrigin: '15.5px 15.5px' }}
          />
          <motion.path data-design-id="m-34f135b4058b"
