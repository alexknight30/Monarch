...
const File01Icon = forwardRef<File01IconHandle, File01IconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <div data-design-id="m-3bee21c8b2a1"
      ...
      >
        <svg
          ...
          overflow="visible"
        >
          <motion.path data-design-id="m-72ea61b5a148"
          ...
          />
          <motion.path data-design-id="m-e954556c26df"
            d="M8 7L16 7"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          />
          <motion.path data-design-id="m-6339e8c62793"
            d="M8 11L12 11"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
