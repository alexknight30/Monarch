...
function Scaled({ height, children }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Scaled.useEffect": ()=>{
            const update = {
                "Scaled.useEffect.update": ()=>setScale(Math.min(1, window.innerWidth / DESIGN_WIDTH))
            }["Scaled.useEffect.update"];
            update();
            window.addEventListener("resize", update);
            return ({
                "Scaled.useEffect": ()=>window.removeEventListener("resize", update)
            })["Scaled.useEffect"];
        }
    }["Scaled.useEffect"], []);
...
_s(Scaled, "KDB8pVNB/ljEOP4LSE5RBlu9Ou0=");
_c = Scaled;
var _c;
...
//# sourceMappingURL=_1f-r-wb._.js.map